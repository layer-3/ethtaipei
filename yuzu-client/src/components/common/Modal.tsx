import React, { useEffect, useState, useRef, type TouchEvent } from "react";
...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children }) => {
    ...
    const handleTouchEnd = () => {
        ...
        const shouldClose = swipeDistance > VERTICAL_SWIPE_THRESHOLD || horizontalSwipeDistance > HORIZONTAL_SWIPE_THRESHOLD;
            ...
            <div
                ...
                style={{
                    transform: `translateX(${
                        animationState === "entering" ? "100%" : animationState === "entered" ? `${horizontalSwipeDistance}px` : "100%"
                    }) translateY(${swipeDistance}px)`,
                    transition: swipeDistance === 0 && horizontalSwipeDistance === 0 ? "transform 300ms ease-in-out" : "none",
                }}
