...
export const AmountEntryStep: React.FC<AmountEntryStepProps> = ({ amount, recipientAddress, availableBalance, onAmountChange, onSubmit }) => {
        ...
        <div className="flex flex-col h-full">
            <div className="flex-1 flex flex-col pt-8">
                <div className="flex-1 flex flex-col items-center justify-center mb-4">
                    ...
                    {isExceedingBalance && <div className="mt-2 text-sm text-red-500">Amount exceeds your available balance</div>}
                </div>
