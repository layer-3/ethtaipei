...
export default function NetworkSelector({ onNetworkChange, className = '' }: NetworkSelectorProps) {
  ...
  const handleNetworkChange = useCallback((chainId: number) => {
    if (onNetworkChange) {
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div id="network-dropdown" className="absolute z-10 mt-1 hidden w-48 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
