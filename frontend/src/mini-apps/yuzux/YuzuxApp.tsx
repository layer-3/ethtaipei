    ...
    >
      <div className="flex justify-between items-center py-2 px-4">
        <div className="flex items-center">
          <Image src="/yuzux.svg" alt="Yuzux" width={40} height={40} className="mr-2" />
          <h1 className="text-lg font-bold text-white">Yuzux</h1>
        </div>
        <button
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className={`text-white text-center transform transition-transform duration-300 ${
          ...
          <div className="flex flex-col items-center mt-4">
            <span className="text-[56px] font-bold leading-none bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">200</span>
